...
function createMultiSelect() {
    ...
    var opt6 = new Option('Sandwich', 'Sandwich');
    var opt7 = new Option('American chopsy', 'American chopsyr');
    var opt8 = new Option('Shwarma', 'Shwarma');
    var opt9 = new Option('Fish fry', 'Fish fry');
    var opt10 = new Option('Ghee rice', 'Biryani');
...
function createState() {
    ...
    select.id = 'state'
    select.setAttribute('class', 'form-control col-6')
    var opt1 = new Option('Tmail Nadu', 'Tamil Nadu');
    var opt2 = new Option('Kerala', 'Kerala');
    var opt3 = new Option('Karnataka', 'Karnataka');
    var opt4 = new Option('Andhra pradesh', 'Andhra pradesh');
    var opt5 = new Option('Delhi', 'Delhi');
    var opt6 = new Option('Mumbai', 'Mumbai');
    var opt7 = new Option('Pondichery', 'Pondichery');
